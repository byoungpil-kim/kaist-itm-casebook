...
11. **기술경영 쟁점은 사례당 1~2개 지정한다.** `assets/meta.json`의 `issues` 배열이 원본이며
    ...
    - 사례당 기술경영 분야는 1~4개다. 상한이 2개가 아니므로, 논지의 축이면 세 번째·네 번째를 붙인다.
      2026-08-19 재검토로 나머지 23건에서 다음을 추가 지정했다.
      - `조직 역량 및 혁신 문화` 6건: 220210·240105·240209·250108·250205·250210
      - `디지털 전환` 9건: 200104(HW→SW·DaaS 전환), 210203(출판만화→웹툰 플랫폼),
        240102(AI·IT·로봇 융복합), 240209(데이터 기반 BML), 240210(스마트 온·블루투스 연동),
        250110(디지털 헬스케어·플랫폼 연동), 250205(비행제어 SW 독자개발·TAMS),
        250215(SW 중심 무기체계·AI 데이터 통합), 260113(디바이스–앱 연동·D2C)
      판단 기준은 **디지털 기술이 분석의 축인가**다. 연구자의 방법론에 그치는 것(220201의 머신러닝
      예측모델, 230107·250108의 특허DB 분석)이나 단순 생산 자동화(230101)는 넣지 않았다.

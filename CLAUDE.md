...
11. **기술경영 쟁점은 사례당 1~2개 지정한다.** `assets/meta.json`의 `issues` 배열이 원본이며
    ...
    - 사례당 기술경영 분야는 1~3개다. 상한이 2개가 아니므로, 논지의 축이면 세 번째를 붙인다.
      2026-08-19 재검토로 `조직 역량 및 혁신 문화` 6건(220210·240105·240209·250108·250205·250210)과
      `디지털 전환` 1건(210203)을 나머지 23건에서 추가 지정했다.
